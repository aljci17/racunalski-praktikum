...
\begin{table}[]
   \centering
   \caption{Magični kvadrat na fasadi Sagrada Família}
   \label{table:sagrada}
  \begin{tabular}
   {|c|c|c|c|}\hline
   16 &  2 &  3 & 12 \\\hline
...
\begin{table}[]
   \centering
   \caption{Komplementarni kvadrat Lo Shu}
   \label{ttable:closhu}
  \begin{tabular}
   {|c|c|c|}\hline
   7 & 6 & 11 \\\hline
...
R. Schroeppel leta 1973 (glej Gardner \cite{gardener}).
...
V tabelah \cite{mag5}, ?!? in ?!? so prikazani
